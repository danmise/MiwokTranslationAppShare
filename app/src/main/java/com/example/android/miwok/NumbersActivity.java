...
public class NumbersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Setting up a click listener to play the audio when the list item is clicked on
    ...
    private void releaseMediaPlayer() {
        ...
        if (mMediaPlayer != null) {
            ...
            //  This also unregisters the AudioFocusChangeListener
            // so we don't get any more callbacks
